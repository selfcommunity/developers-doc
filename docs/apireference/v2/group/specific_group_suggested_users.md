---
sidebar_label: Specific Group Suggested Users
sidebar_position: 1
title: Specific Group Suggested Users
---

This endpoint retrieves the list of all suggested users to invite to a specific group identified by \{id}.
