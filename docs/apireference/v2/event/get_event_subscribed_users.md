---
sidebar_label: Get Event Subscribed Users
sidebar_position: 1
title: Get Event Subscribed Users
---

This endpoint retrieves the list of all the subscribed users to the event identified by \{id}.
...
curl -X GET /api/v2/event/{id}/subscribe/ \
