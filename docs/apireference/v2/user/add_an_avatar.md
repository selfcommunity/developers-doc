...
|---------------|---------------|--------|--------------------------------------|----------------------------------------------------|
| avatar_base64 | body/formdata | string | one between avatar_base64 and avatar | Avatar of the user                                 |
| avatar        | body/formdata | file   | one between avatar_base64 and avatar | Avatar of the user in alternative to avatar_base64 |
