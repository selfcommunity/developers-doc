...
import IncubatorSuggestion from './incubatorSuggestion.js';
import Logged from "../../Logged";

<Logged><IncubatorSuggestion/></Logged>
...
```jsx
 ...
 function App() {
   ...
   return (
     <SCContextProvider conf={conf}><IncubatorSuggestion /></SCContextProvider>
   );
 }
```